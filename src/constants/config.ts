export const CONFIG = {
  ...
  language: 'Fr2 Sante', // This changes the display name for your language
  wordLength: 5, // This sets how long each word is based on how many characters (as defined in orthography.ts) are in each word
  author: 'Mme Jones', // Put your name here so people know who made this Wordle!
  authorWebsite: '', // Put a link to your website or social media here
  wordListSource: 'Fr2', // Describe the source material for your words here
